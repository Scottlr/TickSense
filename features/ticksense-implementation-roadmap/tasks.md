...
| T018 | [ ] | RuneLite Report Panel and Detail Views | Display recent reports, activity summaries, opportunity timelines, and tick-loss breakdowns in RuneLite UI. |  | T017 | [`tasks/T018.md`](tasks/T018.md) |
