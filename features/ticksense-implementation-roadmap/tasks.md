...
| `com.ticksense.activities.execution` | Reusable execution trackers and presets for food recovery, gear switching, prayer switching, target re-engagement, and movement response. | Post-MVP tracker PRs |
...
| T015 | [x] | Araxxor Strategy and Spider Opportunities | Add post-MVP Araxxor spider engagement, re-engagement, damage, and finish-reason analytics. |  | T008, T011, T014, T016, T029, T020 | [`tasks/T015.md`](tasks/T015.md) |
...
| T037 | [x] | Inferno Metrics and Golden Report | Generate Inferno wave/attempt reports and golden replay coverage. |  | T017, T019, T036 | [`tasks/T037.md`](tasks/T037.md) |
