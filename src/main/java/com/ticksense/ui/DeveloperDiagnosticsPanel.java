...
public final class DeveloperDiagnosticsPanel extends JPanel
{
    ...
    public DeveloperDiagnosticsPanel(Supplier<String> diagnosticsTextSupplier, Runnable exportAction)
    {
        ...
        final JScrollPane diagnosticsScrollPane = new JScrollPane(diagnosticsArea);
        diagnosticsScrollPane.setBorder(null);
        add(diagnosticsScrollPane, BorderLayout.CENTER);
        refresh();
    }
